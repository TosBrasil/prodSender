...
const S_U = "https://pmcmwvnbhqplloqtxpzg.supabase.co"
const S_A_K = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InBtY213dm5iaHFwbGxvcXR4cHpnIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MDg5NjYzOTgsImV4cCI6MjAyNDU0MjM5OH0.BSIztlPmAtd5UwoV4aIhxpIGj3-qeesof8gNcV3W4os"
...
const acction = () => {
  ...
  let script = exec('rm -rf /home/deploy/crmdaxxi/*',
    (error, stdout, stderr) => {
      console.log(stdout);
      console.log(stderr);
      if (error !== null) {
